...
[Script]
http-request ^https?:\/\/wx-center\.zippo\.com\.cn\/api\/users\/profile script-path=https://raw.githubusercontent.com/Yuheng0101/X/main/Tasks/zippo.js, timeout=60, tag=𝐙𝐈𝐏𝐏𝐎会员中心获取Authorization
...
const notify = $.isNode() ? require('./sendNotify') : '' // sendNotify.js的相对位置
...
;(async () => {
    ...
    await $.utils.showMsg($.name, '', $.message)
})()
    .catch((e) => $.logErr(e))
    .finally(() => $.done({}))
function apis$1() {
...
\_\_/ |_| \| /_/_ _)_)  \_\/
    ...
    return { getNotice, getVersion, showMsg, isRequest, consoleMe, mergeUrl, isEffectiveVal, getEnv, checkEnv, getJWTExp, isEffectiveTime, getAuth }
}
// prettier-ignore
