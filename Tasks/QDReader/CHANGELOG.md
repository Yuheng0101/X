...
- 所有任务模块新增独立开关，默认仅执行签到，按需开启。
- 新增大咖荐书任务，自动加书架抽奖 / 跳过视频再抽一次。
- 新增每周兑换任务，周日自动兑换章节卡，默认关闭。
- 通知文案优化，移除 emoji。
- 完善 BoxJS 配置，新增 6 个任务开关。
- 更新 Surge / Loon 模块参数，支持任务开关。

## 2026-05-08

- 新增激励碎片任务，自动完成全部广告任务。
- 新增每日任务，自动完成并领取惊喜福利。
- 新增每日抽奖任务，自动观看视频换取抽奖机会并执行全部抽奖。
- 广告任务间等待时间调整为 5–10 秒，降低接口异常概率。
