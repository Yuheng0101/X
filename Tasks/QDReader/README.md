...
| 激励任务 | 自动完成全部广告任务                               | 关闭 |
| 每日任务 | 自动完成并领取惊喜福利                             | 关闭 |
| 每日抽奖 | 自动观看视频换取抽奖机会并执行全部抽奖             | 关闭 |
| 每周兑换 | 周日自动兑换章节卡                                 | 关闭 |
| 章节卡片 | 查询章节卡信息                                     | 关闭 |
| 大咖荐书 | 处理大咖荐书消息（加书架抽奖 / 看视频再抽一次）    | 关闭 |
| 领取奖励 | 领取签到奖励，始终执行                             | 开启 |
...
| `QDREADER_ADV_JOB_ENABLE`       | 是否开启激励任务                             |
| `QDREADER_EXTRA_ADV_JOB_ENABLE` | 是否开启每日任务                             |
| `QDREADER_LOTTERY_ENABLE`       | 是否开启每日抽奖                             |
| `QDREADER_WEEKLY_EXCHANGE_ENABLE` | 是否开启每周兑换                           |
| `QDREADER_CHAPTER_CARD_ENABLE`  | 是否开启章节卡片                             |
| `QDREADER_MESSAGE_BOX_ENABLE`   | 是否开启大咖荐书                             |
